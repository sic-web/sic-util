 ...
 */
function str_maybe_number(target) {
 ...
 */
function str_random(count, radix = 16) {
    radix = math.math_between(radix, 2, 36);
    let result = '';
 ...
 */
function str_no_suffix(s, suffix) {
 ...
 */
function str_complement(n, len = 2, char = '0') {
    n = `${n}`;
 ...
 */
function str_ensure_chinese(str) {
    return str.replace(/[^\u4E00-\u9FA5]/g, '');
}

exports.str_capital = str_capital;
exports.str_capital_all = str_capital_all;
exports.str_complement = str_complement;
exports.str_ensure_chinese = str_ensure_chinese;
exports.str_ensure_prefix = str_ensure_prefix;
exports.str_ensure_suffix = str_ensure_suffix;
exports.str_maybe_number = str_maybe_number;
exports.str_no_prefix = str_no_prefix;
exports.str_no_suffix = str_no_suffix;
exports.str_random = str_random;
exports.str_uuid = str_uuid;
