 ...
 */
function math_to_fixed(n, digit = 0) {
 ...
 */
function math_random_int(from, to) {
 ...
 */
function math_between(v, min, max) {
    if (min > max) {
        [min, max] = [max, min];
    }
...
exports.bytes_to_int = bytes_to_int;
exports.int_to_bytes = int_to_bytes;
exports.math_between = math_between;
exports.math_random_int = math_random_int;
exports.math_to_fixed = math_to_fixed;
exports.math_to_hex = math_to_hex;
