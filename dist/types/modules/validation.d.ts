...
declare const val_age: (_: any, value: any) => Promise<void>;
...
export { val_age, val_amount, val_beforeAfter_space, val_email, val_idcard, val_landline, val_number, val_phone, val_space, val_three_percent, val_two_percent };
